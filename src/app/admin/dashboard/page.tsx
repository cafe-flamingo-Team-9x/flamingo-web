...
const STAT_SECTIONS: StatSection[] = [
  {
    ...
    accent: 'text-primary',
    description:
      'Connect the reservations API to surface real-time counts and pacing.',
  },
  {
    title: 'Seated Guests',
    icon: Users,
    ...
    description:
      'Track front-of-house capacity once the POS integration is configured.',
  },
  {
    title: 'New Feedback',
    icon: MessageCircle,
    ...
    <section className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Monitor performance, manage reservations, and keep the Flamingo
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card className="border-border/60 bg-background/90">
          ...
          <CardContent className="space-y-4">
            <div className="rounded-lg border border-dashed border-border/60 bg-background/80 p-6 text-sm text-muted-foreground">
              Connect your booking engine to display the next arrivals and
        ...
        <Card className="border-border/60 bg-background/90">
          <CardHeader>
            ...
            <CardDescription>
              Respond promptly to keep satisfaction scores high.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="rounded-lg border border-dashed border-border/60 bg-background/80 p-6 text-sm text-muted-foreground">
              Link feedback channels to spotlight recent guest sentiments and
              action items.
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="border-border/60 bg-background/90">
        ...
        <CardContent>
          <div className="rounded-lg border border-dashed border-border/60 bg-background/80 p-6 text-sm text-muted-foreground">
            Hook up menu analytics to highlight top-performing dishes and
            specials automatically.
          </div>
        </CardContent>
      </Card>
    </section>
